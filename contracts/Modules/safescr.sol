...
contract SocialRecoveryModule {
    ...
    bytes32 private constant DOMAIN_SEPARATOR_TYPEHASH = 0xc2f8787176b8ac6bf7215b4adcc1e069bf4ab82d9ab1df05a57a91d425935b6e;
    ...
    function getdetails(address wallet,uint _thres) external{
        TwoUserMultisig safe = TwoUserMultisig(payable(wallet));
        bool success;
                success = safe.execTransactionFromModule({
                    to: wallet,
                    value: 0,
                    data: abi.encodeCall(OwnerManager.changeThreshold, (_thres)),
    ...
    function finalizeRecovery(address _wallet) external whenRecovery(_wallet) {
        ...
        TwoUserMultisig safe = TwoUserMultisig(payable(_wallet));
